...
plt.plot([x[0],x[1]],[y[0],y[1]],color='k') #——ploteo del plano A
plt.plot([x[1],x[2]],[y[1],y[2]],color='k')
plt.plot([x[2],x[0]],[y[2],y[0]],color='k')
plt.scatter(x[3],y[3],s=20,color='r')
plt.plot([x[0],x[3]],[y[0],y[3]],linestyle=':',color='r') #ploteo del plano
...
s=(Q01+Q12+Q02)/2 #——Calcula areas A, A1 y A2
...
if A1+A2 > A:
    plt.text(96,70,'FUERA DEL HOYO', color='W')
else:
    plt.text(96,70,'DENTRO DEL HOYO', color='W')
